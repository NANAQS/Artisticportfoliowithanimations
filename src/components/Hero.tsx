    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-screen py-20">
          ...
          {/* Left Side - Character with greeting */}
          <motion.div
              ...
              >
                ...
                >
                  <div className="relative bg-white text-slate-900 px-6 py-3 rounded-2xl shadow-xl">
                    <p className="whitespace-nowrap">Olá! Bem-vindo! ✨</p>
          ...
          >
            ...
            >
              ...
              >
                Creating vibrant illustrations, character designs, and digital paintings that capture emotion and imagination
              </motion.p>
              ...
              {/* Animated stats - Horizontal layout */}
              <motion.div
                ...
                {[
                  ...
                  >
                    ...
                    <div className="relative bg-white/5 backdrop-blur-sm rounded-lg px-3 py-2 md:px-6 md:py-4 border border-white/10">
                      <motion.div
                        className="text-white mb-0 md:mb-1 text-sm md:text-base"
                      >
                        {stat.number}
                      </motion.div>
                      <p className="text-slate-400 text-xs md:text-sm whitespace-nowrap">{stat.label}</p>
                    </div>
                  </motion.div>
                ))}
              </motion.div>
